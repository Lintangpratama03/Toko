...
class OrderController extends Controller
{
	...
	private function _generatePaymentToken($order)
	{
		...
		$params = [
			...
			'transaction_details' => [
				'order_id' => $order->code, // Ensure this is unique
		...
		try {
			...
			if ($snap->token) {
				...
				// Handle case where snap token is not generated
			...
			// Handle the error gracefully, notify user, or retry logic
			// Example: return redirect()->back()->withError('Failed to create transaction');
		}
	}
